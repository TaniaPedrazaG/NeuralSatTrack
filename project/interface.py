...
class AppInterface:
    def __init__(self, root):
        ...
        ttk.Style().configure("TCheckbutton", padding=10, font=('Helvetica', 12))
        ...
        self.controll_frame = ttk.Frame(root, width=200, height=200)
        self.controll_frame.grid(row=1, column=0, sticky="nsew")

        # Canvas para mostrar el mapa
        self.checkbox_frame = ttk.Frame(root, width=200, height=400)
        self.checkbox_frame.grid(row=0, column=1, rowspan=2, sticky="nsew")
