...
# Parsing of TLE
tle = Tle("""ISS (ZARYA)
1 25544U 98067A   24055.76463962  .00070080  00000-0  12541-2 0  9999
2 25544  51.6403 157.4567 0005698 285.7504 173.0809 15.49319938440968""")
...
img = Path(__file__).parent / "world_map.png"
